function cmd() {
  //var valorNumero = document.getElementById("valorNumero");
  //numeroEntrada = valorNumero.value;
  //var valorTexto = document.getElementById("valorTexto");
  //textoEntrada = valorTexto.value
    ...
    //valores brutos de cada metal
        ...
        var cont = 0
        var SM = 0
        var NM = prompt('Quantos metais você irá utilizar ?\n no maximo são 8:\n caso queira sair digite [E]')//limite contador
        if (NM === 'e' && "E") {return} 
        ...
        var test
        var m2
        var m1 = prompt('Coloque na forja os metais que você ira usar entre: \n[NT]  [IO]  [NY]  [HZ]  [KL]  [PL]  [NG]  [SS] \n mas lembre-se UM DE CADA VEZ" \ncaso queira sair digite [E]')
        //if (m1 === 'e' && "E") {return}  
    ...
    default : test = prompt('Esse tipo de minéiro não é proprio para ser forjar. Por favor saia digitando [E]  e recomece ');
      ...
      alert('CONCLUIMOS! Caso queira repetir alimente mais a forja com carvão!') 
    ...
    var valorObtido = "seu novo " + itemName+" ("+ weapon +") possui de bonus de " + itemFinal;
